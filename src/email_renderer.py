...
<div class='section'><h3>섹션 B. 오늘의 핵심 뉴스 5개 📈💱</h3>{_news_cards(brief['top_news'])}</div>
<div class='section'><h3>섹션 C. Ashford Sterling 투자 해석</h3><ul>{''.join([f'<li>{i}</li>' for i in brief['interpretation']])}</ul></div>
<div class='section'><h3>섹션 D. 오늘의 일본어 여행 문장 3개 🇯🇵</h3>{phrases_html}</div>
</div></body></html>
"""
